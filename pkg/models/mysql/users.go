...
func (m *UserModel) ChangePassword(id int, currentPassword, newPassword string) error {
	// Retrieve the user details for the user with the ID given by the id parameter.
	...
	//Check that the currentPassword value matches the hashed password for the user. If if doesn’t match, return an models.ErrInvalidCredentials error.
